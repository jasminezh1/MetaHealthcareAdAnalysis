...
for filename in filenames:
    ...
    count, emojiCount = count_emojis(filename)

    csv_file_path = 'emojiFinal.csv'
    new_line = [keyword] + [count] + [emojiCount]
